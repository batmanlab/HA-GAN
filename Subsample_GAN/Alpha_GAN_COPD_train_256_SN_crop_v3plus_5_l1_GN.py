...
from Model_Alpha_GAN_256_SN_GN_v3 import Discriminator, Generator, Encoder, Sub_Encoder
...
def main():
    ...
    latent_dim = 1024
    basename = str(img_size)+"_"+str(latent_dim)+"_Alpha_SN_v3plus_5_l1_GN_threshold_600"
    SAVE_MODEL = True
