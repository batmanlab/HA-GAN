...
def prepare_parser():
    ...
    parser.add_argument(
        '--Arc', action='store_true', default=False,
        help='Augment with random crops and flips (default: %(default)s)')
...
# Convenience dicts
dset_dict = {'I32': dset.ImageFolder, 'I64': dset.ImageFolder,'VGGFACE500':dset.ILSVRC_HDF5,'VGGFACE200':dset.ILSVRC_HDF5,'VGGFACE100':dset.ILSVRC_HDF5,
             'VGGFACE1000':dset.ILSVRC_HDF5,'VGGFACE2000':dset.ILSVRC_HDF5,
             'I128': dset.ImageFolder, 'I256': dset.ImageFolder,
             'I32_hdf5': dset.ILSVRC_HDF5, 'I64_hdf5': dset.ILSVRC_HDF5,
             'I128_hdf5': dset.ILSVRC_HDF5, 'I256_hdf5': dset.ILSVRC_HDF5,
             'C10': dset.CIFAR10, 'C100': dset.CIFAR100,
             'Lung': dset.Lung}
imsize_dict = {'I32': 32, 'I32_hdf5': 32,'VGGFACE500':64,'VGGFACE200':64,'VGGFACE1000':64,'VGGFACE2000':64,'VGGFACE100':64,
               'I64': 64, 'I64_hdf5': 64,
               'I128': 128, 'I128_hdf5': 128,
               'I256': 256, 'I256_hdf5': 256,
               'C10': 32, 'C100': 32, 'Lung': 256}
root_dict = {'I32': 'ImageNet', 'I32_hdf5': 'ILSVRC32.hdf5','VGGFACE500':'VGGFACE50064.hdf5','VGGFACE200':'VGGFACE20064.hdf5','VGGFACE100':'VGGFACE10064.hdf5',
             'VGGFACE1000':'VGGFACE100064.hdf5','VGGFACE2000':'VGGFACE200064.hdf5',
             'I64': 'ImageNet', 'I64_hdf5': 'ILSVRC64.hdf5',
             'I128': 'ImageNet', 'I128_hdf5': 'ILSVRC128.hdf5',
             'I256': 'ImageNet', 'I256_hdf5': 'ILSVRC256.hdf5',
             'C10': 'cifar', 'C100': 'cifar', 'Lung': ''}
nclass_dict = {'I32': 1000, 'I32_hdf5': 1000,'VGGFACE200':200,'VGGFACE500':500,'VGGFACE1000':1000,'VGGFACE2000':2000,'VGGFACE100':100,
               'I64': 1000, 'I64_hdf5': 1000,
               'I128': 1000, 'I128_hdf5': 1000,
               'I256': 1000, 'I256_hdf5': 1000,
               'C10': 10, 'C100': 100,'Lung':1}
# Number of classes to put per sample sheet
classes_per_sheet_dict = {'I32': 50, 'I32_hdf5': 50,'VGGFACE1000':100,'VGGFACE2000':100,
                          'I64': 50, 'I64_hdf5': 50,
...
def save_weights(G, D,BI, state_dict, weights_root, experiment_name,
    ...
    torch.save(BI.state_dict(),
               '%s/%s.pth' % (root, join_strings('_', ['BI', name_suffix])))
    torch.save(BI.optim.state_dict(),
               '%s/%s.pth' % (root, join_strings('_', ['BI_optim', name_suffix])))
...
def load_weights(G, D,BI, state_dict, weights_root, experiment_name,
    ...
    if BI is not None:
        BI.load_state_dict(
            torch.load('%s/%s.pth' % (root, join_strings('_', ['BI', name_suffix]))),
            strict=strict)
        if load_optim:
            BI.optim.load_state_dict(
                torch.load('%s/%s.pth' % (root, join_strings('_', ['BI_optim', name_suffix]))))
    # Load state dict
